...
<script type="text/html" data-template-name="failure">
    <div class="form-row">
    ...
    <div class="form-row">
        <label for="node-input-uuid"><i class="fa fa-tasks"></i> <span data-i18n="failure.label.uuid"></span></label>
        <input type="text" id="node-input-uuid" data-i18n="[placeholder]failure.label.uuid">
    </div>

    <div class="form-row">
        <label for="node-input-probability"><i class="fa fa-tasks"></i> <span data-i18n="failure.label.probability"></span></label>
        <input type="text" id="node-input-probability" data-i18n="[placeholder]failure.label.probability">
    </div>

    <div class="form-row">
        <label for="node-input-description"><i class="fa fa-tasks"></i> <span data-i18n="failure.label.description"></span></label>
        <input type="text" id="node-input-description" data-i18n="[placeholder]failure.label.description">
    </div>
