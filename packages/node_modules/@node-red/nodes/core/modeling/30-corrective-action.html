...
<script type="text/html" data-template-name="corrective-action">
    ...
    <div class="form-row">
        <label for="node-input-user-level"><i class="fa fa-tasks"></i> <span data-i18n="correctiveaction.label.user-level"></span></label>
        <input type="text" id="node-input-user-level" data-i18n="[placeholder]correctiveaction.label.user-level">
    </div>
