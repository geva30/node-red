...
<script type="text/html" data-template-name="corrective-action">
    <div class="form-row">
    ...
    <div class="form-row">
        <label for="node-input-uuid"><i class="fa fa-tasks"></i> <span data-i18n="correctiveaction.label.uuid"></span></label>
        <input type="text" id="node-input-uuid" data-i18n="[placeholder]corrective-action.label.uuid">
    </div>
    ...
    <div class="form-row">
        <label for="node-input-executiontime"><i class="fa fa-tasks"></i> <span data-i18n="correctiveaction.label.execution-time"></span></label>
        <input type="text" id="node-input-executiontime" data-i18n="[placeholder]correctiveaction.label.execution-time">
    </div>

    <div class="form-row">
        <label for="node-input-cost"><i class="fa fa-tasks"></i> <span data-i18n="correctiveaction.label.cost"></span></label>
        <input type="text" id="node-input-cost" data-i18n="[placeholder]correctiveaction.label.cost">
    </div>
...
<script type="text/javascript">
    RED.nodes.registerType('corrective-action',{
        color:"#AABD8C",
        category: 'modeling',
        defaults: {
            name: {value:""},
        ...
        inputs:1,
        outputs:0,
        icon: "corrective-action.svg",
        label: function() {
            return this.name||"corrective action";
        },
        labelStyle: function() {
