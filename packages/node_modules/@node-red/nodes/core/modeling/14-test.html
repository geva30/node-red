...
<script type="text/html" data-template-name="test">
    ...
    <div class="form-row">
        <label for="node-input-userlevel"><i class="fa fa-tasks"></i> <span data-i18n="test.label.user-level"></span></label>
        <input type="text" id="node-input-userlevel" data-i18n="[placeholder]test.label.user-level">
    </div>

    <div class="form-row">
        <label for="node-input-description"><i class="fa fa-tasks"></i> <span data-i18n="component.label.description"></span></label>
