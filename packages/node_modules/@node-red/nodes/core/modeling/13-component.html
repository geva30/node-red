...
<script type="text/html" data-template-name="component">
    <div class="form-row">
    ...
    <div class="form-row">
        <label for="node-input-uuid"><i class="fa fa-tasks"></i> <span data-i18n="component.label.uuid"></span></label>
        <input type="text" id="node-input-uuid" data-i18n="[placeholder]component.label.uuid">
    </div>
    ...
    <div class="form-row">
        <label for="node-input-MTBF"><i class="fa fa-tasks"></i> <span data-i18n="component.label.MTBF"></span></label>
        <input type="text" id="node-input-MTBF" data-i18n="[placeholder]component.label.MTBF">
    </div>

    <div class="form-row">
        <label for="node-input-cost"><i class="fa fa-tasks"></i> <span data-i18n="component.label.cost"></span></label>
        <input type="text" id="node-input-cost" data-i18n="[placeholder]component.label.cost">
    </div>

    <div class="form-row">
        <label for="node-input-imageurl"><i class="fa fa-tasks"></i> <span data-i18n="component.label.image-url"></span></label>
        <input type="text" id="node-input-imageurl" data-i18n="[placeholder]component.label.image-url">
    </div>
